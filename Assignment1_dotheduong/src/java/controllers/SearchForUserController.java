...
public class SearchForUserController extends HttpServlet {
    ...
    //private static final String SUCCESS_ADIMN="management.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int count=1;
            count = dao.getCountFoodForUser(name, price, type);
            int totalPage=0;
            if (count % 20 != 0) {
            ...
            List<FoodDTO> list=dao.getListFoodForSearchInUserLimit(name, price, type,page);
